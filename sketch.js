...
function preload(){
  ...
  pinkCyclistAnimation = loadAnimation("opponent1.png","opponent2.png");
  pinkCyclistFall = loadAnimation("opponent3.png");
    yellowCyclistAnimation = loadAnimation("opponent4.png","opponent5.png");
  yellowCyclistFall = loadAnimation("opponent6.png");
    redCyclistAnimation = loadAnimation("opponent7.png","opponent8.png");
...
function draw() {
  ...
  if(gameState===PLAY){
    ...
    textSize(20);
    fill(255);
    text("Press 'R' to Restart the game", camera.position.x-100,displayHeight-600);
